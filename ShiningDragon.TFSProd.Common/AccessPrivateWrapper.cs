...
namespace ShiningDragon.TFSProd.Common
{
    ...
    public class AccessPrivateWrapper : DynamicObject
    {
        ...
        /// </summary>
        static BindingFlags _flags = BindingFlags.NonPublic | BindingFlags.Instance
        ...
        /// </summary>
        public static dynamic FromType(Assembly asm, BindingFlags flags, string type, params object[] args)
        {
            ...
            var ty = types.ToArray();
            //Gets the constructor matching the specified set of args
            var ctor = t.GetConstructor(flags, null, ty, null);
        ...
        public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result)
        {
            ...
            var method = _wrapped.GetType().GetMethod
                (binder.Name, _flags, null, types.ToArray(), null);
        ...
        public override bool TryGetMember(System.Dynamic.GetMemberBinder binder, out object result)
        {
            ...
            var prop = _wrapped.GetType().GetProperty(binder.Name, _flags);

            if (prop == null)
            {
                //Try getting a field of that name
                var fld = _wrapped.GetType().GetField(binder.Name, _flags);
                if (fld != null)
                {
